...
- não explorar medo ou dificuldade financeira;
- não prometer lucro, aumento de renda, retorno do investimento, retenção de pacientes ou autoridade profissional;
- não inventar data, vagas, descontos ou condições;
...
export const PROSTHODONTICS_TRAINING_DOCUMENTS: OfficialTrainingDocument[] = [
  {
    ...
    title: "Script Comercial — Especialização em Prótese Dentária",
    content: PROSTHODONTICS_COMMERCIAL_SCRIPT,
    active: true,
    metadata: {
  ...
  {
    documentType: "faq",
    title: "FAQ atualizado — Especialização em Prótese Dentária",
    content: PROSTHODONTICS_FAQ,
    active: true,
    metadata: {
      version: PROSTHODONTICS_TRAINING_VERSION,
  ...
  },
  {
    ...
    title: "Matriz de Públicos — Especialização em Prótese Dentária",
    content: PROSTHODONTICS_AUDIENCE_MATRIX,
    active: true,
    metadata: {
      version: PROSTHODONTICS_TRAINING_VERSION,
  ...
  },
  {
    ...
    title: "Follow-ups — Especialização em Prótese Dentária",
    content: PROSTHODONTICS_FOLLOW_UPS,
    active: false,
    metadata: {
      version: PROSTHODONTICS_TRAINING_VERSION,
